...

{
    ...
    public static Byte toByte(Object object)
    {
        ...
        switch (type)
        {
            ...
            case 13:
                return Byte.valueOf(Long.valueOf(((java.util.Date)object).getTime()).byteValue());
            case 15:
    ...
    public static Double toDouble(Object object)
    {
        ...
        switch (type)
        {
            ...
            case 13:
                return Double.valueOf(Long.valueOf(((java.util.Date)object).getTime()).doubleValue());
            case 15:
    ...
    public static Float toFloat(Object object)
    {
        ...
        switch (type)
        {
            ...
            case 13:
                return Float.valueOf((float)((java.util.Date)object).getTime());
            case 15:
    ...
    public static Integer toInteger(Object object)
    {
        ...
        switch (type)
        {
            ...
            case 13:
                return Integer.valueOf((int)((java.util.Date)object).getTime());
            case 15:
    ...
    public static Short toShort(Object object)
    {
        ...
        switch (type)
        {
            ...
            case 13:
                return Short.valueOf((short)(int)((java.util.Date)object).getTime());
            case 15:
    ...
    public static Object getObject(String type, String value)
    {
        if (StringUtil.isNotEmptyString(type))
        {
            ...
            if (java.sql.Date.class.getName().toUpperCase().equals(type.toUpperCase())) {
                return new java.sql.Date(new java.util.Date(value).getTime());
            }
    ...
    static
    {
        ...
        typeMap.put(java.util.Date.class, Integer.valueOf(91));
