...
public class Knife4jConfig {
    ...
    public Docket docket(Environment environment) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .enable(flag)
                //所在分组
                .groupName("app设备及业务管理接口")
                .select()
                //指定扫描的包路径
                .apis(Predicates.or(
                        RequestHandlerSelectors.basePackage("com.app.device.impl.controller")
                        ,RequestHandlerSelectors.basePackage("com.app.device.handler")
                ))
