package com.hdpt.device.impl.controller.mqtt;


import com.github.xiaoymin.knife4j.annotations.ApiOperationSupport;
import com.hdpt.device.config.MqttProviderConfig;
...
public class SendController {
    ...
    @ApiOperation(value = "开锁", notes = "开锁")
    ...
    @ApiOperation(value = "关锁", notes = "关锁")
