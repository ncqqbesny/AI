...
import com.soft.mapp.basecenter.modules.system.LogParam;
import com.soft.mapp.basecenter.services.ISysLogService;
import com.soft.mapp.basecenter.type.BaseConst;
import com.soft.mapp.basecenter.type.LogConst;
...
public class PointAutoLog {
    ...
    @Pointcut("@annotation(com.soft.mapp.basecenter.modules.system.AutoLog)")
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, Object result) {
        ...
        try {
            ...
            this.sysLogService.addLogInfo(sysLog);
            //log.info("日志处理结束");
        } catch (Exception e) {
