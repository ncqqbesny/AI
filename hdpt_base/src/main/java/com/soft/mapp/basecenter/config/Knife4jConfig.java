...
public class Knife4jConfig {
    ...
    public Docket docket(Environment environment) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                //指定扫描的包路径
                .apis(Predicates.or(
                        RequestHandlerSelectors.basePackage("com.soft.mapp.basecenter.impl.controller")
                        //,RequestHandlerSelectors.basePackage("com.soft.mapp.basecenter.handler")
                ))
