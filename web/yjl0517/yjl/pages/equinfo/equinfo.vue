		...
		<view :class="popshow ?  'pop show' :  'pop hidden'" v-if="showClick">
			...
			<view class="pop_item">
				...
				<view class="btnGroup">
					...
					<view class="btn" @click="closeLock2()">
		...
		<!-- 物资仓锁控 -->
			<view class="footer">
				...
				<uni-popup ref="alertEdit" type="dialog">
					<uni-popup-dialog :type="msgType" cancelText="关闭" confirmText="同意" title="通知" content="是否保存设备设备信息?" @confirm="confirmEdit"
						@close="dialogClose"></uni-popup-dialog>
				</uni-popup>
			</view>
		</view>
